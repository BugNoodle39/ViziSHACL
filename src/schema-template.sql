-- ViziSHACL schema template
-- Adapted from viziquer-tools/db/init/pg/02-empty.sql
-- The word 'empty' is replaced at runtime with the target schema name.
-- DROP statements removed (only used when schema does not exist).
-- COPY blocks converted to INSERT (COPY FROM stdin is not supported via pg wire protocol).
...
-- Seed data (converted from COPY to INSERT)

INSERT INTO empty.annot_types (id, iri, ns_id, local_name) OVERRIDING SYSTEM VALUE VALUES
...
INSERT INTO empty.cc_rel_types (id, name) OVERRIDING SYSTEM VALUE VALUES
(1, 'sub_class_of'),
(2, 'equivalent_class'),
(3, 'intersecting_class');

INSERT INTO empty.cp_rel_types (id, name) OVERRIDING SYSTEM VALUE VALUES
(1, 'incoming'),
(2, 'outgoing'),
(3, 'type_constraint'),
(4, 'value_type_constraint');

INSERT INTO empty.pp_rel_types (id, name) OVERRIDING SYSTEM VALUE VALUES
(1, 'followed_by'),
(2, 'common_subject'),
(3, 'common_object'),
(4, 'sub_property_of');

INSERT INTO empty.ns (id, name, value, priority, is_local, basic_order_level) OVERRIDING SYSTEM VALUE VALUES
(1,  'rdf',      'http://www.w3.org/1999/02/22-rdf-syntax-ns#',          0, false, 0),
(2,  'rdfs',     'http://www.w3.org/2000/01/rdf-schema#',                 0, false, 0),
(3,  'xsd',      'http://www.w3.org/2001/XMLSchema#',                     0, false, 0),
(4,  'skos',     'http://www.w3.org/2004/02/skos/core#',                  0, false, 0),
(5,  'dct',      'http://purl.org/dc/terms/',                             0, false, 0),
(6,  'dc',       'http://purl.org/dc/elements/1.1/',                      0, false, 0),
(7,  'owl',      'http://www.w3.org/2002/07/owl#',                        0, false, 0),
(8,  'foaf',     'http://xmlns.com/foaf/0.1/',                            0, false, 0),
(9,  'schema',   'http://schema.org/',                                    0, false, 0),
(10, 'dbo',      'http://dbpedia.org/ontology/',                          0, false, 0),
(11, 'yago',     'http://dbpedia.org/class/yago/',                        0, false, 0),
(12, 'wd',       'http://www.wikidata.org/entity/',                       0, false, 0),
(13, 'wdt',      'http://www.wikidata.org/prop/direct/',                  0, false, 0),
(14, 'shacl',    'http://www.w3.org/ns/shacl#',                          0, false, 0),
(15, 'dcat',     'http://www.w3.org/ns/dcat#',                           0, false, 0),
(16, 'void',     'http://rdfs.org/ns/void#',                             0, false, 0),
(17, 'virtrdf',  'http://www.openlinksw.com/schemas/virtrdf#',            0, false, 0),
(18, 'dav',      'http://www.openlinksw.com/schemas/DAV#',               0, false, 0),
(19, 'dbp',      'http://dbpedia.org/property/',                          0, false, 0),
(20, 'dbr',      'http://dbpedia.org/resource/',                          0, false, 0),
(21, 'dbt',      'http://dbpedia.org/resource/Template:',                 0, false, 0),
(22, 'dbc',      'http://dbpedia.org/resource/Category:',                 0, false, 0),
(23, 'cc',       'http://creativecommons.org/ns#',                        0, false, 0),
(24, 'vann',     'http://purl.org/vocab/vann/',                           0, false, 0),
(25, 'geo',      'http://www.w3.org/2003/01/geo/wgs84_pos#',             0, false, 0),
(26, 'prov',     'http://www.w3.org/ns/prov#',                           0, false, 0),
(27, 'sd',       'http://www.w3.org/ns/sparql-service-description#',     0, false, 0),
(28, 'frbr',     'http://vocab.org/frbr/core#',                          0, false, 0),
(29, 'georss',   'http://www.georss.org/georss/',                         0, false, 0),
(30, 'gold',     'http://purl.org/linguistics/gold/',                     0, false, 0),
(31, 'bibo',     'http://purl.org/ontology/bibo/',                        0, false, 0),
(32, 'umbel',    'http://umbel.org/umbel#',                               0, false, 0),
(33, 'umbel-rc', 'http://umbel.org/umbel/rc/',                            0, false, 0),
(34, 'dul',      'http://www.ontologydesignpatterns.org/ont/dul/DUL.owl#',0, false, 0),
(35, 'voaf',     'http://purl.org/vocommons/voaf#',                       0, false, 0),
(36, 'gr',       'http://purl.org/goodrelations/v1#',                     0, false, 0),
(37, 'org',      'http://www.w3.org/ns/org#',                            0, false, 0),
(38, 'sioc',     'http://rdfs.org/sioc/ns#',                             0, false, 0),
(39, 'vcard',    'http://www.w3.org/2006/vcard/ns#',                     0, false, 0),
(40, 'obo',      'http://purl.obolibrary.org/obo/',                       0, false, 0),
(68, 'bif',      'http://www.openlinksw.com/schemas/bif#',               0, false, 0);

INSERT INTO empty.parameters (order_inx, name, textvalue, jsonvalue, comment, id) OVERRIDING SYSTEM VALUE VALUES
(30,  'endpoint_url',              NULL, NULL, 'Default endpoint URL for visual environment projects using this schema (can be overridden in induvidual project settings).', 3),
(40,  'named_graph',               NULL, NULL, 'Default named graph for visual environment projects using this schema.', 4),
(210, 'instance_name_pattern',     NULL, NULL, 'Default pattern for instance name presentation in visual query fields. Work in progress. Can be overriden on individual class level. Leave empty to present instances by their URIs.', 10),
(330, 'use_instance_table',        NULL, NULL, 'Mark, if a dedicated instance table is installed within the data schema (requires a custom solution).', 8),
(240, 'use_pp_rels',               NULL, NULL, 'Use the property-property relationships from the data schema in the query auto-completion (the property-property relationships must be retrieved from the data and stored in the pp_rels table).', 9),
(230, 'instance_lookup_mode',      NULL, NULL, 'table - use instances table, default - use data endpoint', 19),
(250, 'direct_class_role',         NULL, NULL, 'Default property to be used for instance-to-class relationship. Leave empty in the most typical case of the property being rdf:type.', 5),
(260, 'indirect_class_role',       NULL, NULL, 'Fill in, if an indirect class membership is to be used in the environment, along with the direct membership (normally leave empty).', 6),
(20,  'schema_description',        NULL, NULL, 'Description of the schema.', 2),
(100, 'tree_profile_name',         NULL, NULL, 'Look up public tree profile by this name (mutually exclusive with local tree_profile).', 14),
(110, 'tree_profile',              NULL, NULL, 'A custom configuration of the entity lookup pane tree (copy the initial value from the parameters of a similar schema).', 11),
(200, 'schema_kind',               NULL, NULL, 'One of: default, dbpedia, wikidata, ... .', 13),
(220, 'show_instance_tab',         NULL, NULL, 'Show instance tab in the entity lookup pane in the visual environment.', 15),
(500, 'schema_extraction_details', NULL, NULL, 'JSON with parameters used in schema extraction.', 17),
(510, 'schema_import_datetime',    NULL, NULL, 'Date and time when the schema has been imported from extracted JSON data.', 18),
(90,  'db_schema_name',            NULL, NULL, 'Name of the schema by which it is to be known in the visual query environment (must be unique).', 1),
(10,  'display_name_default',      NULL, NULL, 'Recommended display name to be used in schema registry.', 20),
(60,  'endpoint_public_url',       NULL, NULL, 'Human readable web site of the endpoint, if available.', 16),
(50,  'endpoint_type',             NULL, NULL, 'Type of the endpoint (GENERIC, VIRTUOSO, JENA, BLAZEGRAPH), associated by default with the schema (can be overridden in a project).', 12);
